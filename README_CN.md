...
#### [基础模型与预训练](#基础模型与大规模预训练) <sup>4 个数据集</sup>
...
#### [语义分割与制图](#语义分割与地物制图) <sup>4 个数据集</sup>
...
#### [变化检测与灾害](#变化检测与灾害评估) <sup>4 个数据集</sup>
...
#### [农业与时间序列](#农业与卫星时间序列) <sup>3 个数据集</sup>
